...
import { UpdateMainOrderStatusCommand } from './update-main-order-status.command';

@CommandHandler(UpdateMainOrderStatusCommand)
export class UpdateMainOrderStatusCommandHandler
  implements ICommandHandler<UpdateMainOrderStatusCommand>
{
  constructor(
  ...
  async execute(command: UpdateMainOrderStatusCommand) {
